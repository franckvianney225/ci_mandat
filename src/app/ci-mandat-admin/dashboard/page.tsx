...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    // En production, vous devrez vérifier le token JWT ou la session
    const checkAuth = () => {
      // Simulation de vérification d'authentification
      // En production, vérifiez le token dans localStorage ou cookies
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-gray-500">Gestion des demandes</p>
              </div>
            </div>
            <button
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">En erreur</dt>
                ...
                <li className="px-4 py-4 sm:px-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="ml-2 text-sm text-gray-500">Département X</span>
                    </div>
                  </div>
                </li>
                <li className="px-4 py-4 sm:px-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <div className="text-sm font-medium text-gray-900">Marie Smith</div>
                        <div className="text-sm text-gray-500">marie.smith@email.com</div>
                      </div>
                    </div>
                    <div className="flex items-center">
                      ...
                      <span className="ml-2 text-sm text-gray-500">Département Y</span>
                    </div>
                  </div>
                </li>
                <li className="px-4 py-4 sm:px-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-sm text-gray-500">pierre.martin@email.com</div>
                      </div>
                    </div>
                    <div className="flex items-center">
                      ...
                      <span className="ml-2 text-sm text-gray-500">Département Z</span>
                    </div>
                  </div>
                </li>
              </ul>
